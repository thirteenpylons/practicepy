...
"""
Assess part 1, the function list_inspection_violations
...
def check_func1(package,module):
    """
    Checks that the function list_inspection_violations works correctly
    ...
    if not result[0]:
        print("The function 'list_inspection_violations' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func1('auditor','inspections.py'))