...
def grade_func2(package,module,step=0,outp=sys.stdout):
    ...
    failures = [[],
                [INPUTFILE,TESTFLAG],
                [TESTFLAG,INPUTFILE],
                [INPUTFILE,OUTPUTFILE,TESTFLAG],
                [INPUTFILE,TESTFLAG,OUTPUTFILE],
                [TESTFLAG,INPUTFILE,OUTPUTFILE],
                [INPUTFILE,OUTPUTFILE,EXTRAFILE]]
