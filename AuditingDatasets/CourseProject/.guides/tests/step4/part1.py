...
"""
Assess part 1, the function discover_violations
...
def check_func1(package,module):
    """
    Checks that the function discover_violations works correctly
    ...
    if not result[0]:
        print("The function 'discover_violations' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func1('auditor','app.py'))