...
"""
Assess part 1, the function get_certification
...
def check_func1(package,module):
    """
    Checks that the function get_certification works correctly
    ...
    if not result[0]:
        print("The function 'get_certification' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func1('auditor','pilots.py'))