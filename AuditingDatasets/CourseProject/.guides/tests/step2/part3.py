...
"""
Assess part 3, the function get_minimums
...
def check_func3(package,module):
    """
    Checks that the function get_minimums works correctly
    ...
    if not result[0]:
        print("The function 'get_minimums' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func3('auditor','pilots.py'))