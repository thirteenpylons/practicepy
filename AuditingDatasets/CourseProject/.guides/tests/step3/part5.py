...
"""
Assess part 5, the function get_weather_violation
...
def check_func5(package,module):
    """
    Checks that the function get_weather_violation works correctly
    ...
    if not result[0]:
        print("The function 'get_weather_violation' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func5('auditor','violations.py'))