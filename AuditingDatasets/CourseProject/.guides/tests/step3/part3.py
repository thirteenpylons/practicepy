...
"""
Assess part 3, the function bad_ceiling
...
def check_func3(package,module):
    """
    Checks that the function bad_ceiling works correctly
    ...
    if not result[0]:
        print("The function 'bad_ceiling' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func3('auditor','violations.py'))