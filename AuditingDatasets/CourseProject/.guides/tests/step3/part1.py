...
"""
Assess part 1, the function bad_visibility
...
def check_func1(package,module):
    """
    Checks that the function bad_visibility works correctly
    ...
    if not result[0]:
        print("The function 'bad_visibility' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func1('auditor','violations.py'))