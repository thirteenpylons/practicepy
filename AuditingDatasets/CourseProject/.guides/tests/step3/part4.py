...
"""
Assess part 4, the function get_weather_report
...
def check_func4(package,module):
    """
    Checks that the function get_weather_report works correctly
    ...
    if not result[0]:
        print("The function 'get_weather_report' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func4('auditor','violations.py'))