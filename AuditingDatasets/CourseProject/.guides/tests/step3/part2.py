...
"""
Assess part 2, the function bad_winds
...
def check_func2(package,module):
    """
    Checks that the function bad_winds works correctly
    ...
    if not result[0]:
        print("The function 'bad_winds' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func2('auditor','violations.py'))