...
"""
Assess part 4, the function bad_ifr
...
def check_func4(package,module):
    """
    Checks that the function bad_ifr works correctly
    ...
    """
    outp = HTMLizer()
    result = verifier.grade_func7(package,module,0,outp)
    if not result[0]:
        print("The function 'bad_ifr' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func4('auditor','endorsements.py'))