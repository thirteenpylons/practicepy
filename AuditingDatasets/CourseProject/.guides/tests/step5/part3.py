...
"""
Assess part 3, the function bad_endorsement
...
def check_func3(package,module):
    """
    Checks that the function bad_endorsement works correctly
    ...
    if not result[0]:
        print("The function 'bad_endorsement' looks correct.")
    return result[0]


if __name__ == '__main__':
    sys.exit(check_func3('auditor','endorsements.py'))